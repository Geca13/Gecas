...
public class GecasApplication {
	...
	public void init() {
		...
		try {
			...
			itemRepository.save(new MenuItem(5L,null, "BeffStake 300 gr", 500.00, subRepository.findById(9L).get(), beefstake,  "https://i.dlpng.com/static/png/7307915_preview.png", true));
			itemRepository.save(new MenuItem(6L,null, "Pork Ribs 500gr", 450.00, subRepository.findById(9L).get(), porkRibs,  "https://www.rockrecipes.com/wp-content/uploads/2016/08/Make-Ahead-Ribs-close-up-photo-of-individually-cut-ribs.jpg", true));
			itemRepository.save(new MenuItem(7L,null, "Kebap 10 pc", 200.00, subRepository.findById(9L).get(), kebap,  "https://image.shutterstock.com/image-photo/balkan-cuisine-cevapi-grilled-dish-260nw-1026969340.jpg", true));
			itemRepository.save(new MenuItem(8L,null, "Chicken Brest 300gr", 250.00, subRepository.findById(9L).get(), chicken,  "https://www.africanbites.com/wp-content/uploads/2018/07/IMG_2425.jpg", true));
			itemRepository.save(new MenuItem(9L,null, "Salmon 500gr", 400.00, subRepository.findById(11L).get(), salmon,  "https://www.cookingclassy.com/wp-content/uploads/2019/06/brown-sugar-lime-baked-salmon-22-768x1152.jpg", true));
			itemRepository.save(new MenuItem(10L,null, "Orada 500gr", 750.00, subRepository.findById(11L).get(), orada,  "https://image.jimcdn.com/app/cms/image/transf/dimension=455x1024:format=jpg/path/sdcd146a3ef2c96c2/image/ic3e7c4fbee3b0795/version/1610023607/image.jpg", true));
			itemRepository.save(new MenuItem(11L,null, "Trout 500gr", 800.00, subRepository.findById(11L).get(), trout,  "https://media-cdn.tripadvisor.com/media/photo-s/18/6b/0a/50/ohrid-trout.jpg", true));
			itemRepository.save(new MenuItem(12L,null, "Millanezze", 250.00, subRepository.findById(12L).get(), milaneze,  "https://www.mastercook.com/app/Image/8487222/2718046.jpg", true));
			itemRepository.save(new MenuItem(13L,null, "Bollogneze", 250.00, subRepository.findById(12L).get(), bolonjeze,  "https://www.homemaderecipesfromscratch.com/wp-content/webp-express/webp-images/uploads/2020/05/spaghetti-bolognese-1-official-1024x576.png.webp", true));
			itemRepository.save(new MenuItem(14L,null, "4 x 50 gr Cheese Plate", 250.00, subRepository.findById(13L).get(), cheese,  "https://media.istockphoto.com/photos/mixed-cheese-platter-picture-id509760299?s=612x612", true));
			itemRepository.save(new MenuItem(15L,null, "4 x 100 gr Cheese Plate", 450.00, subRepository.findById(13L).get(), cheese,  "https://image.shutterstock.com/image-photo/cheese-platter-plate-mixed-600w-655605481.jpg", true));
			itemRepository.save(new MenuItem(16L,null, "4 x 50 gr Dry Meats Plate", 350.00, subRepository.findById(13L).get(), meat,  "https://thumbs.dreamstime.com/z/mixed-italian-dried-meats-platter-croutons-grapes-plate-located-black-table-as-background-172798616.jpg", true));
			itemRepository.save(new MenuItem(17L,null, "4 x 100 gr Dry Meats Plate", 650.00, subRepository.findById(13L).get(), meat,  "https://previews.123rf.com/images/jackf/jackf2002/jackf200204919/140547016-top-view-of-traditional-spanish-meat-platter-sliced-dry-cured-jamon-bacon-and-sausages-on-wooden-boa.jpg", true));
			itemRepository.save(new MenuItem(18L,null, "600 gr Mixed Fried Plate", 250.00, subRepository.findById(14L).get(), fried,  "https://media-cdn.tripadvisor.com/media/photo-s/18/55/56/86/single-fried-platter.jpg", true));
			itemRepository.save(new MenuItem(19L,null, "Sopska", 120.00, subRepository.findById(10L).get(), sopska,  "https://makturk.com/wp-content/uploads/2016/03/shopska-salata-2-696x464.jpg", true));
			itemRepository.save(new MenuItem(20L,null, "Mixed Fresh", 100.00, subRepository.findById(10L).get(), mixed,  "https://kajmece.com/wp-content/uploads/2016/01/mesana-salata.jpg", true));
			itemRepository.save(new MenuItem(21L,null, "Cezar", 200.00, subRepository.findById(10L).get(), cezar,  "https://cdn.shortpixel.ai/client/to_webp,q_lossy,ret_img,w_630/http://napravisam.mk/wp-content/uploads/2016/02/Ednostaven-recept-za-preubava-Cezar-salata-1.jpg", true));
			itemRepository.save(new MenuItem(22L,null, "Macedonian", 130.00, subRepository.findById(10L).get(), macedonian,  "https://moirecepti.mk/content/uploads/2020/07/IMG_20200709_164052_149-1f6c28-800x483.jpg", true));
			...
			itemRepository.save(new MenuItem(27L,null,"Strachatella", 150.00, subRepository.findById(7L).get(),strachatela, "https://www.karlijnskitchen.com/wp-content/uploads/2019/07/low-fodmap-stracciatella-ijs-beter-1.jpg",true));
			itemRepository.save(new MenuItem(28L,null,"Ohridska", 150.00, subRepository.findById(8L).get(),ohrid, "https://i.pinimg.com/564x/48/4c/80/484c80d8126113a059f22d7d36e6fd9a.jpg", true));
			itemRepository.save(new MenuItem(29L,null,"Cheese Cake", 150.00, subRepository.findById(8L).get(), cheeseCake,"https://sugarspunrun.com/wp-content/uploads/2019/01/Best-Cheesecake-Recipe-2-1-of-1-7.jpg", true));
			itemRepository.save(new MenuItem(30L,null,"Nutella And Nuts", 150.00, subRepository.findById(8L).get(),nutellaCake,"https://i.pinimg.com/564x/0a/4d/2f/0a4d2fb7fa6109d8329a965de528957f.jpg", true));

			itemRepository.save(new MenuItem(31L,producerRepository.findById(1L).get(),"Fanta 1 lit",50.00,subRepository.findById(4L).get(),null,"https://www.paket.mk/wp-content/uploads/2017/06/ZMA32111-800x800.jpg", true));
			itemRepository.save(new MenuItem(32L,producerRepository.findById(1L).get(),"Coca-Cola 1 lit",80.00,subRepository.findById(4L).get(),null,"https://www.paket.mk/wp-content/uploads/2018/07/ZMA28243-1-800x800.jpg",true));
			itemRepository.save(new MenuItem(33L,producerRepository.findById(1L).get(),"Fanta 0.5 lit",40.00,subRepository.findById(4L).get(),null,"https://www.paket.mk/wp-content/uploads/2017/06/ZMA12305-800x800.jpg", true));
			itemRepository.save(new MenuItem(34L,producerRepository.findById(1L).get(),"Coca-Cola 0.5 lit",40.00,subRepository.findById(4L).get(),null,"https://www.paket.mk/wp-content/uploads/2019/11/SKP19437-1-800x800.jpg",true));
			itemRepository.save(new MenuItem(35L,producerRepository.findById(1L).get(),"Skopsko 1,5 lit",120.00,subRepository.findById(2L).get(),null,"https://e-tinex.mk/TinexImagesPrivremeno/501563.jpg", true));
			itemRepository.save(new MenuItem(36L,producerRepository.findById(1L).get(),"Skopsko Smuth 1,5 lit",150.00,subRepository.findById(2L).get(),null,"https://e-tinex.mk/TinexImagesPrivremeno/600290.jpg",true));
			itemRepository.save(new MenuItem(37L,producerRepository.findById(1L).get(),"Skopsko 0.5 lit",80.00,subRepository.findById(2L).get(),null,"https://cdn.shopify.com/s/files/1/2216/3143/products/Skopsko-0.33l_800x.jpg?v=1569050875", true));
			itemRepository.save(new MenuItem(38L,producerRepository.findById(1L).get(),"Heineken 0.33 lit",100.00,subRepository.findById(2L).get(),null,"https://www.paket.mk/wp-content/uploads/2017/06/ZMA20794-1-800x800.jpg",true));
		
			itemRepository.save(new MenuItem(39L,producerRepository.findById(2L).get(),"Zlaten Dab 0.5 lit",80.00,subRepository.findById(2L).get(),null,"https://verodrive.vero.com.mk/wp-content/uploads/2020/04/2600898020pivo20zlaten20dab20klasik200.5l20staklo.jpg", true));
			itemRepository.save(new MenuItem(40L,producerRepository.findById(2L).get(),"Zlaten Dab Dark 0.33 lit",70.00,subRepository.findById(2L).get(),null,"https://verodrive.vero.com.mk/wp-content/uploads/2020/04/2600466920pivo20zlaten20dab20temno200.5l.jpg",true));
			itemRepository.save(new MenuItem(41L,producerRepository.findById(2L).get(),"Pepsi 1 lit",50.00,subRepository.findById(4L).get(),null,"https://beercastleny.com/wp-content/uploads/2017/11/Pepsi-Bottles-1L-1ct.jpg", true));
			itemRepository.save(new MenuItem(42L,producerRepository.findById(2L).get(),"Zlaten Dab 1,5 lit",100.00,subRepository.findById(2L).get(),null,"https://e-tinex.mk/TinexImagesPrivremeno/300505.jpg",true));
			itemRepository.save(new MenuItem(43L,producerRepository.findById(2L).get(),"Pepsi 0.5 lit",40.00,subRepository.findById(4L).get(),null,"https://secure.ce-tescoassets.com/assets/CZ/509/8594008040509/ShotType1_540x540.jpg", true));
			itemRepository.save(new MenuItem(44L,producerRepository.findById(2L).get(),"Tuborg 0.75 lit",90.00,subRepository.findById(2L).get(),null,"https://e-tinex.mk/TinexImagesPrivremeno/115019.jpg",true));
			
			itemRepository.save(new MenuItem(45L,producerRepository.findById(8L).get(),"Gorska Negazirana 1 lit",70.00,subRepository.findById(5L).get(),null,"https://kupigorska.mk/sites/default/files/images/products/gorska_negazirana_staklo_0.75_nova_etiketa_novo_kapache_635x687.png", true));
			itemRepository.save(new MenuItem(46L,producerRepository.findById(8L).get(),"Gorska Gazirana 1,5 lit",70.00,subRepository.findById(5L).get(),null,"https://onestopshop.mk/wp-content/uploads/2020/07/gorska-voda-gazirana-1.5l-011790-600x600.jpg",true));
			itemRepository.save(new MenuItem(47L,producerRepository.findById(8L).get(),"Gorska Negazirana 0.25 lit",80.00,subRepository.findById(5L).get(),null,"https://www.gorska.com.mk/sites/default/files/2014/09/01/gorska_sport_par_flashi_0.png", true));
			itemRepository.save(new MenuItem(48L,producerRepository.findById(8L).get(),"Gorska Gazirana 0.25 lit",100.00,subRepository.findById(5L).get(),null,"https://onestopshop.mk/wp-content/uploads/2021/03/3-2-1-600x600.jpg",true));
			itemRepository.save(new MenuItem(49L,producerRepository.findById(7L).get(),"Pelisterka Gazirana 1,5 lit",80.00,subRepository.findById(5L).get(),null,"https://onestopshop.mk/wp-content/uploads/2020/09/pelisterka-gazirana-1.5l-10150-600x600.jpg", true));
			...
			itemRepository.save(new MenuItem(56L,producerRepository.findById(3L).get(),"Bela Voda 0.75 lit",1700.00,subRepository.findById(1L).get(),null,"https://www.ediskont.rs/uploads/store/products/images/bela_voda_tikves_075l_507.jpg",true));
			itemRepository.save(new MenuItem(57L,producerRepository.findById(3L).get(),"T'ga za jug 0.25 lit",180.00,subRepository.findById(1L).get(),null,"https://www.ediskont.rs/uploads/store/products/thumbnails/tmb-tga_za_jug_tikves_075l_145.jpg", true));
			itemRepository.save(new MenuItem(58L,producerRepository.findById(3L).get(),"Alexandria belo 0.25 lit",160.00,subRepository.findById(1L).get(),null,"https://www.ediskont.rs/uploads/store/products/thumbnails/tmb-vino_aleksandria_bela_02l_568.jpg",true));
			itemRepository.save(new MenuItem(59L,producerRepository.findById(3L).get(),"Alexandria crveno 0.25 lit",160.00,subRepository.findById(1L).get(),null,"https://www.ediskont.rs/uploads/store/products/thumbnails/tmb-aleksandria_crna_02l_931.jpg", true));
			itemRepository.save(new MenuItem(60L,producerRepository.findById(3L).get(),"Barovo 0.75 lit",1800.00,subRepository.findById(1L).get(),null,"https://wine.mk/wp-content/uploads/2017/11/Barovo-White-png.png",true));
			itemRepository.save(new MenuItem(61L,producerRepository.findById(4L).get(),"Dissan 0.75 lit",1770.00,subRepository.findById(1L).get(),null,"https://wine.mk/wp-content/uploads/2017/11/9_Bovin-Dissan-Barrique-2010-750ml-375x400.png", true));
			itemRepository.save(new MenuItem(62L,producerRepository.findById(4L).get(),"Darron 0.75 lit",1700.00,subRepository.findById(1L).get(),null,"https://wine.mk/wp-content/uploads/2017/11/bovin-red-wine-daron-375x400.png",true));
			itemRepository.save(new MenuItem(63L,producerRepository.findById(4L).get(),"Alexandar 0.75 lit",1140.00,subRepository.findById(1L).get(),null,"https://wine.mk/wp-content/uploads/2020/04/bovin-red-wine-alexandar-375x400.png", true));
			itemRepository.save(new MenuItem(64L,producerRepository.findById(4L).get(),"Venus 0.75 lit",1190.00,subRepository.findById(1L).get(),null,"https://wine.mk/wp-content/uploads/2017/11/bovin-red-wine-venus-375x400.png",true));
			itemRepository.save(new MenuItem(65L,producerRepository.findById(4L).get(),"Imperator 0.75 lit",2770.00,subRepository.findById(1L).get(),null,"https://wine.mk/wp-content/uploads/2017/11/bovin-red-wine-imperator-375x400.png", true));
			itemRepository.save(new MenuItem(66L,producerRepository.findById(4L).get(),"Chardonnay 0.75 lit",1700.00,subRepository.findById(1L).get(),null,"https://wine.mk/wp-content/uploads/2020/04/Chardonnay-the-one-copy-375x400.png",true));
			itemRepository.save(new MenuItem(67L,producerRepository.findById(4L).get(),"Chardonnay Barique 0.75 lit",3180.00,subRepository.findById(1L).get(),null,"https://wine.mk/wp-content/uploads/2017/11/5_Chardonnay-Barrique-375x400.png", true));
			itemRepository.save(new MenuItem(68L,producerRepository.findById(4L).get(),"Temjanika 0.75 lit",1160.00,subRepository.findById(1L).get(),null,"https://wine.mk/wp-content/uploads/2017/11/Muscat-Temjanika-375x400.png",true));
			itemRepository.save(new MenuItem(69L,producerRepository.findById(4L).get(),"Sv. Trifun 0.5 lit",760.00,subRepository.findById(3L).get(),null,"https://wine.mk/wp-content/uploads/2020/04/bovin-brandy-yellow-375x400.png", true));
			itemRepository.save(new MenuItem(70L,producerRepository.findById(4L).get(),"Sv. Trifun Premium 0.5 lit",1200.00,subRepository.findById(3L).get(),null,"https://wine.mk/wp-content/uploads/2020/04/bovin-brandy-sv-trifun-premium-375x400.png",true));
